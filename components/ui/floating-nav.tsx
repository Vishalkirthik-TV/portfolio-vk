  ...
  return (
    <AnimatePresence mode="wait">
      <motion.nav
        ...
        className={cn(
          "fixed inset-x-0 top-10 z-[5000] mx-auto flex max-w-4xl items-center justify-between rounded-3xl border border-white/[0.2] bg-black-100 px-6 py-2 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]",
          className
        )}
      >
        {/* Logo Container */}
